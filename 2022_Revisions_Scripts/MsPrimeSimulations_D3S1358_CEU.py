...
model = msprime.SMM(lo=29, hi=38)
STR_mu = str(0.001194664) #D3S1358
SNP_mu = str(2e-8)
...
def save_genotypes_byPop(strs, snps, num_samples, s_len, rep):
	...
	STR_name = "D3S1358"
	output_dir = "../Reps_Output/D3S1358/"
	...
	D3S1358_1 = alleles[str_info.genotypes]

	# We add adjacent rows for diploid genotypes (taking the average of the STR)
	D3S1358 = (D3S1358_1[::2] + D3S1358_1[1::2])/2

	# Subset Admixed (first samples) and European Samples 
	D3S1358_Admx = D3S1358[:num_samples]
	D3S1358_EUR = D3S1358[num_samples:]
	...
	np.savetxt(adx_str_fname, D3S1358_Admx, fmt='%1.2f')
	np.savetxt(adx_snp_fname, snps_Admx, fmt='%1d')
	np.savetxt(eur_str_fname, D3S1358_EUR, fmt='%1.2f')
